...
Public Class Conexion
    Public conexion As SqlConnection = New SqlConnection("Data Source= LAPTOP-L0NU1VSF\; Initial Catalog=tiendaIIIp ; Integrated Security=True")
    ...
    Public Function insertarUsuario(ID As Integer, nombre As String, apellido As String, username As String, psw As String, rol As String, estado As String, correo As String)
        Try
            conexion.Open()
